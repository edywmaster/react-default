...
import { ArrowRightIcon, ExternalLinkIcon, CopyIcon, CheckIcon } from '@radix-ui/react-icons'
  ...
  return (
    ...
    >
      <Container size="3">
        ...
        >
          Desenvolvimento e design de soluções mobile e web
        </Heading>
        <Paragraph
          size="2"
          css={{
        ...
        >
          Nascemos para mostrar ao mundo que um software deve ser inteligente e proativo.
        </Paragraph>
        <Flex css={{ '@bp1': { jc: 'center', my: '$7' } }}>

          <NextLink href="https://ewm.app.br/" passHref>
          ...
          <HomepageButton
            as="a"
            href="https://github.com/edywmaster"
            target="_blank"
